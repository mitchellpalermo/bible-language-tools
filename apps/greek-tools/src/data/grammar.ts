...
export interface ParticipleParadigm {
  ...
  /** forms[case][number][gender] — full inflected form */
  forms: Record<CaseKey, Record<NumKey, Record<GenderKey, string>>>;
  /** endings[case][number][gender] — inflectional suffix after the verbal stem */
  endings: Record<CaseKey, Record<NumKey, Record<GenderKey, string>>>;
}
...
export const participleParadigms: ParticipleParadigm[] = [
  // ── Present ───────────────────────────────────────────────────────────────
  {
    ...
    endings: {
      nom: { sg: { m: 'ων', f: 'ουσα', n: 'ον' }, pl: { m: 'οντες', f: 'ουσαι', n: 'οντα' } },
      gen: {
        sg: { m: 'οντος', f: 'ούσης', n: 'οντος' },
        pl: { m: 'όντων', f: 'ουσῶν', n: 'όντων' },
      },
      dat: {
        sg: { m: 'οντι', f: 'ούσῃ', n: 'οντι' },
        pl: { m: 'ουσι(ν)', f: 'ούσαις', n: 'ουσι(ν)' },
      },
      acc: { sg: { m: 'οντα', f: 'ουσαν', n: 'ον' }, pl: { m: 'οντας', f: 'ούσας', n: 'οντα' } },
      voc: { sg: { m: 'ων', f: 'ουσα', n: 'ον' }, pl: { m: 'οντες', f: 'ουσαι', n: 'οντα' } },
    },
  },
  {
    ...
    endings: {
      nom: {
        sg: { m: 'όμενος', f: 'ομένη', n: 'όμενον' },
        pl: { m: 'όμενοι', f: 'όμεναι', n: 'όμενα' },
      },
      gen: {
        sg: { m: 'ομένου', f: 'ομένης', n: 'ομένου' },
        pl: { m: 'ομένων', f: 'ομένων', n: 'ομένων' },
      },
      dat: {
        sg: { m: 'ομένῳ', f: 'ομένῃ', n: 'ομένῳ' },
        pl: { m: 'ομένοις', f: 'ομέναις', n: 'ομένοις' },
      },
      acc: {
        sg: { m: 'όμενον', f: 'ομένην', n: 'όμενον' },
        pl: { m: 'ομένους', f: 'ομένας', n: 'όμενα' },
      },
      voc: {
        sg: { m: 'όμενε', f: 'ομένη', n: 'όμενον' },
        pl: { m: 'όμενοι', f: 'όμεναι', n: 'όμενα' },
      },
    },
  },
  ...
  // ── Aorist ────────────────────────────────────────────────────────────────
  {
    ...
    endings: {
      nom: { sg: { m: 'ας', f: 'ασα', n: 'αν' }, pl: { m: 'αντες', f: 'ασαι', n: 'αντα' } },
      gen: { sg: { m: 'αντος', f: 'άσης', n: 'αντος' }, pl: { m: 'άντων', f: 'ασῶν', n: 'άντων' } },
      dat: { sg: { m: 'αντι', f: 'άσῃ', n: 'αντι' }, pl: { m: 'ασι(ν)', f: 'άσαις', n: 'ασι(ν)' } },
      acc: { sg: { m: 'αντα', f: 'ασαν', n: 'αν' }, pl: { m: 'αντας', f: 'άσας', n: 'αντα' } },
      voc: { sg: { m: 'ας', f: 'ασα', n: 'αν' }, pl: { m: 'αντες', f: 'ασαι', n: 'αντα' } },
    },
  },
  {
    id: 'aor-mid-ptc',
    ...
    endings: {
      nom: {
        sg: { m: 'άμενος', f: 'αμένη', n: 'άμενον' },
        pl: { m: 'άμενοι', f: 'άμεναι', n: 'άμενα' },
      },
      gen: {
        sg: { m: 'αμένου', f: 'αμένης', n: 'αμένου' },
        pl: { m: 'αμένων', f: 'αμένων', n: 'αμένων' },
      },
      dat: {
        sg: { m: 'αμένῳ', f: 'αμένῃ', n: 'αμένῳ' },
        pl: { m: 'αμένοις', f: 'αμέναις', n: 'αμένοις' },
      },
      acc: {
        sg: { m: 'άμενον', f: 'αμένην', n: 'άμενον' },
        pl: { m: 'αμένους', f: 'αμένας', n: 'άμενα' },
      },
      voc: {
        sg: { m: 'άμενε', f: 'αμένη', n: 'άμενον' },
        pl: { m: 'άμενοι', f: 'άμεναι', n: 'άμενα' },
      },
    },
  },
  {
    ...
    endings: {
      nom: { sg: { m: 'είς', f: 'εῖσα', n: 'έν' }, pl: { m: 'έντες', f: 'εῖσαι', n: 'έντα' } },
      gen: {
        sg: { m: 'έντος', f: 'είσης', n: 'έντος' },
        pl: { m: 'έντων', f: 'εισῶν', n: 'έντων' },
      },
      dat: {
        sg: { m: 'έντι', f: 'είσῃ', n: 'έντι' },
        pl: { m: 'εῖσι(ν)', f: 'είσαις', n: 'εῖσι(ν)' },
      },
      acc: { sg: { m: 'έντα', f: 'εῖσαν', n: 'έν' }, pl: { m: 'έντας', f: 'είσας', n: 'έντα' } },
      voc: { sg: { m: 'είς', f: 'εῖσα', n: 'έν' }, pl: { m: 'έντες', f: 'εῖσαι', n: 'έντα' } },
    },
  },
  // ── Perfect ───────────────────────────────────────────────────────────────
  {
    ...
    endings: {
      nom: { sg: { m: 'ώς', f: 'υῖα', n: 'ός' }, pl: { m: 'ότες', f: 'υῖαι', n: 'ότα' } },
      gen: { sg: { m: 'ότος', f: 'υίας', n: 'ότος' }, pl: { m: 'ότων', f: 'υιῶν', n: 'ότων' } },
      dat: { sg: { m: 'ότι', f: 'υίᾳ', n: 'ότι' }, pl: { m: 'όσι(ν)', f: 'υίαις', n: 'όσι(ν)' } },
      acc: { sg: { m: 'ότα', f: 'υῖαν', n: 'ός' }, pl: { m: 'ότας', f: 'υίας', n: 'ότα' } },
      voc: { sg: { m: 'ώς', f: 'υῖα', n: 'ός' }, pl: { m: 'ότες', f: 'υῖαι', n: 'ότα' } },
    },
  },
  {
    ...
    endings: {
      nom: { sg: { m: 'μένος', f: 'μένη', n: 'μένον' }, pl: { m: 'μένοι', f: 'μέναι', n: 'μένα' } },
      gen: {
        sg: { m: 'μένου', f: 'μένης', n: 'μένου' },
        pl: { m: 'μένων', f: 'μένων', n: 'μένων' },
      },
      dat: {
        sg: { m: 'μένῳ', f: 'μένῃ', n: 'μένῳ' },
        pl: { m: 'μένοις', f: 'μέναις', n: 'μένοις' },
      },
      acc: {
        sg: { m: 'μένον', f: 'μένην', n: 'μένον' },
        pl: { m: 'μένους', f: 'μένας', n: 'μένα' },
      },
      voc: { sg: { m: 'μένε', f: 'μένη', n: 'μένον' }, pl: { m: 'μένοι', f: 'μέναι', n: 'μένα' } },
    },
  },
];
